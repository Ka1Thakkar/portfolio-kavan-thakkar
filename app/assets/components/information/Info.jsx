    ...
    return (
        <section id="info" className="relative w-full h-full bg-black/80 flex justify-center items-center">
            <div className="bg-black w-10/12 h-[80vh] rounded-xl relative p-10 overflow-y-scroll">
                <div onClick={()=>setInfoVisibility(false)} className='absolute top-5 right-5 rounded-full p-2 bg-white text-black'>
                    <RxCross2 />
                </div>
                <h1 className={dm.className + ' text-4xl lg:text-6xl text-textbeige uppercase pb-2'}>About this website (and me)</h1>
                <hr />
