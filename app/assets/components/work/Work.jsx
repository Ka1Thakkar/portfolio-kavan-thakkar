...
const Work = () => {
    ...
    return (
        <section ref={element} className="bg-beige min-h-screen py-20 flex flex-col items-center px-5 lg:px-10 xl:px-40 2xl:px-60">
          <div  data-scroll data-scroll-speed="0.15" className="flex flex-col justify-center items-center">
            ...
            <Image src={underline} alt="underline" className="w-9/12 lg:w-full object-cover" />
          </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center pt-5 gap-10">
              {work.map((item, i)=>(
                <div key={i} data-scroll data-scroll-speed = {i%2 === 0 ? "0.15" : "0.1"} className={" flex flex-col justify-center h-[50vh] rounded-xl gap-5"}>
                  <div className={item.color + " rounded-xl pt-36 lg:pt-40 pl-5 lg:pl-10 overflow-hidden bg-opacity-70 relative " + styles.linkdiv}>
                    <div className="absolute top-10 left-5 lg:left-10 pr-10">
